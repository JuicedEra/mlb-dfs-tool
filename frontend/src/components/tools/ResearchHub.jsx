            ...
            <table>
              <thead>
                <tr>
                  ...
                  <th data-tooltip="Player name">Player</th>
                  <th data-tooltip="Team">Team</th>
                  <th data-tooltip="Today's pitcher matchup">Today's Matchup</th>
                  {activeLens === "streaks"    && <><th data-tooltip="Consecutive games with at least 1 hit">Streak</th><th data-tooltip="Batting average over last 7 games">L7 AVG</th><th data-tooltip="Full season batting average">Season AVG</th><th data-tooltip="Hits and at-bats over last 7 games">H / AB (L7)</th></>}
                  {activeLens === "season_gwh" && <><th data-tooltip="Number of games this season with at least 1 hit">G w/ Hit</th><th data-tooltip="Total games played this season">G Played</th><th data-tooltip="Percentage of games with at least 1 hit">Hit Rate</th><th data-tooltip="Full season batting average">Season AVG</th></>}
                  {activeLens === "l7"         && <><th data-tooltip="Batting average over last 7 games">L7 AVG</th><th data-tooltip="Hits in last 7 games">H</th><th data-tooltip="At-bats in last 7 games">AB</th>{extraCols.tb&&<th data-tooltip="Total bases in last 7 games">TB</th>}{extraCols.slg&&<th data-tooltip="Slugging % in last 7 games">SLG</th>}{extraCols.k&&<th data-tooltip="Strikeouts in last 7 games">K</th>}</>}
                  {activeLens === "l3"         && <><th data-tooltip="Batting average over last 3 games">L3 AVG</th><th data-tooltip="Hits in last 3 games">H</th><th data-tooltip="At-bats in last 3 games">AB</th>{extraCols.tb&&<th data-tooltip="Total bases in last 3 games">TB</th>}{extraCols.slg&&<th data-tooltip="Slugging % in last 3 games">SLG</th>}{extraCols.k&&<th data-tooltip="Strikeouts in last 3 games">K</th>}</>}
                  {activeLens === "yesterday"  && <><th data-tooltip="Hits in yesterday's game">H Yesterday</th><th data-tooltip="At-bats yesterday">AB</th><th data-tooltip="Home runs yesterday">HR</th>{extraCols.tb&&<th data-tooltip="Total bases yesterday">TB</th>}{extraCols.slg&&<th data-tooltip="Slugging % yesterday">SLG</th>}</>}
                  {activeLens === "platoon"    && <><th data-tooltip="Pitcher handedness today (L or R)">vs Hand</th><th data-tooltip="Career batting average vs this pitcher handedness">Split AVG</th><th data-tooltip="On-base percentage vs this handedness">OBP</th><th data-tooltip="Number of at-bats in this platoon split">Sample</th><th data-tooltip="Full season batting average">Season AVG</th></>}
                  {activeLens === "homeaway"   && <><th data-tooltip="Whether this game is home or away">Today's Split ▼</th><th data-tooltip="Career batting average in home games">Home AVG</th><th data-tooltip="Career batting average in away games">Away AVG</th><th data-tooltip="Day or night game context">Context</th></>}
                  {activeLens === "daynight"   && <><th data-tooltip="Career batting average in day games">Day AVG</th><th data-tooltip="Career batting average in night games">Night AVG</th><th data-tooltip="Whether today's game is day or night">Today</th><th data-tooltip="The relevant split for today's game — highlighted column">Relevant AVG ▼</th></>}
                  {activeLens === "multi_hit"  && <><th data-tooltip="Games with 2+ hits">2+ Hit G</th><th data-tooltip="Total games played this season">G Played</th><th data-tooltip="Percentage of games with 2+ hits">Multi-Hit %</th><th data-tooltip="Full season batting average">Season AVG</th></>}
                  {activeLens === "season_avg" && <><th data-tooltip="Full season batting average">Season AVG</th><th data-tooltip="Total season hits">H</th><th data-tooltip="Total season at-bats">AB</th><th data-tooltip="On-base plus slugging percentage">OPS</th></>}
                  {activeLens === "xba"        && <><th data-tooltip="Expected batting avg from Statcast — based on exit velocity and launch angle">xBA</th><th data-tooltip="Actual batting average this season">Actual BA</th><th data-tooltip="xBA minus actual BA — positive means unlucky, likely to improve">Diff</th><th data-tooltip="Barrel rate — % of batted balls at optimal exit velo and angle">Barrel%</th></>}
                  {activeLens === "power"      && <><th data-tooltip="Slugging percentage — total bases per at-bat">SLG</th><th data-tooltip="Full season batting average">Season AVG</th><th data-tooltip="Isolated power — slugging minus batting average, measures extra-base ability">ISO</th><th data-tooltip="On-base plus slugging percentage">OPS</th></>}
                </tr>
              </thead>
              <tbody>
                {!isPremium && filtered.length > 0 && (
                  <tr>
                    <td colSpan="99" style={{ padding: "8px 16px", background: "linear-gradient(90deg, rgba(245,158,11,0.06), rgba(21,128,61,0.06))", textAlign: "center", borderBottom: "1px solid rgba(245,158,11,0.1)" }}>
                      ...
                      <span style={{ fontSize: 10, fontWeight: 700, color: "var(--yellow)" }}>Top 5 players are PRO-only</span>
