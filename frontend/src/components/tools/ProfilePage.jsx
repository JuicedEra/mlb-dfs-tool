...
function ShareCard({ user, stats, currentTier, equippedAchievement, onClose }) {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 600, background: "rgba(0,0,0,0.85)", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}
      ...
      <div style={{ background: "var(--surface)", borderRadius: 16, border: "1px solid var(--border)", padding: 24, maxWidth: 660, width: "100%" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
          <span style={{ fontFamily: "var(--font-display)", fontSize: 17, fontWeight: 800, color: "var(--text-primary)" }}>Share Performance Card</span>
          <button className="close-btn" onClick={onClose}><span className="material-icons">close</span></button>
        </div>
        <canvas ref={canvasRef} style={{ borderRadius: 12, width: "100%", maxWidth: 600, display: "block", margin: "0 auto 16px" }} />
